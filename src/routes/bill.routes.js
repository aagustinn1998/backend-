...
export default class BillRouter {
  ...
  initBillRoutes() {
    ...
    // Iniciar el proceso de compra de una factura
    this.router.post(
      ...
      async (req, res, next) => {
        try {
          ...
          const successUrl = new URL(`/api/${API_VERSION}/${this.path}/${billId}/finish-checkout`, API_URL);
          successUrl.searchParams.append("transactionId", transactionId);
    ...
    // Manejar la cancelación del proceso de compra
